    ...
    <div className="p-5 sm:py-8 sm:px-8">
      <div>
        <H4
          ...
          <div className="font-bold block md:inline">
            {isRecipes ? 'Ví dụ' : 'Thử thách'} {currentChallenge.order} trên{' '}
            {totalChallenges}
      ...
      <div className="flex justify-between items-center mt-4">
        {currentChallenge.hint ? (
          <div>
            ...
            <Button
              ...
              {showSolution ? 'Ẩn đáp án' : 'Hiện đáp án'}
            </Button>
          </div>
        ) : (
          !isRecipes && (
        ...
        {hasNextChallenge && (
          <Button
            ...
            active>
            {isRecipes ? 'Ví dụ tiếp theo' : 'Thử thách tiếp theo'}
      ...
      {showSolution && (
        <div className="mt-6">
          ...
          <div className="flex justify-between items-center mt-4">
            <Button onClick={() => setShowSolution(false)}>Đóng đáp án</Button>
            {hasNextChallenge && (
              <Button
                className={cn(
